...
oceans_elight = Movie.create(title: "Ocean's Eight", overview: "Debbie Ocean, a criminal mastermind, gathers a crew of female thieves to pull off the heist of the century.", poster_url: "https://image.tmdb.org/t/p/original/MvYpKlpFukTivnlBhizGbkAe3v.jpg", rating: 7.0)

romance = List.create(name: "Romance")
titanic_bookmark = Bookmark.create(comment: "sth", list: romance, movie: titanic)

inspiring = List.create(name: "inspiring")
the_shawshank_redemption_bookmark = Bookmark.create(comment: "sth", list: inspiring, movie: the_shawshank_redemption)

comedy = List.create(name: "comedy")
oceans_elight_bookmark = Bookmark.create(comment: "sth", list: comedy, movie: oceans_elight)

hero = List.create(name: "hero")
wonder_woman_1984_bookmark = Bookmark.create(comment: "sth", list: hero, movie: wonder_woman_1984)
